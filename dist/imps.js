...
exports.butler = exports.calculateDatum = exports.crossImps = exports.toImps = void 0;
const imps = [
    { diff: 0, imps: 0 },
    { diff: 20, imps: 1 },
    { diff: 50, imps: 2 },
...
exports.toImps = toImps;
function crossImps(results) {
...
exports.crossImps = crossImps;
function calculateDatum(games) {
    if (games.length > 3) {
...
exports.calculateDatum = calculateDatum;
function butler(results) {
